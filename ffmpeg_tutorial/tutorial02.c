...
// Use
//
// gcc -o tutorial02 tutorial02.c -lavutil -lavformat -lavcodec -lz -lm -lswscale `pkg-config --cflags --libs sdl`
// to build (assuming libavformat and libavcodec are correctly installed, 
// and assuming you have pkg-config. Please refer to SDL docs for your installation.)
// To install all dev package for compiling this code, run this on ubuntu:
